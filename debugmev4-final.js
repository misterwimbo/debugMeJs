...
(function() {
    ...
    onReady(function debugJsMain() {
        ...
        topLeftCorner.style.background = 'linear-gradient(135deg, rgba(20, 25, 33, 0.98) 0%, rgba(30, 35, 48, 0.95) 100%)';
        topLeftCorner.style.backdropFilter = 'blur(16px) saturate(180%)';
        topLeftCorner.style.padding = '16px 20px';
        topLeftCorner.style.zIndex = '99999';
        topLeftCorner.style.color = '#f8fafc';
        topLeftCorner.style.display = 'none';
        topLeftCorner.style.borderRadius = '12px';
        topLeftCorner.style.border = '1px solid rgba(148, 163, 184, 0.2)';
        topLeftCorner.style.boxShadow = '0 24px 48px rgba(0, 0, 0, 0.4), 0 12px 24px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.08)';
        topLeftCorner.style.fontFamily = '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif';
        topLeftCorner.style.fontSize = '14px';
        topLeftCorner.style.lineHeight = '1.5';
        topLeftCorner.style.letterSpacing = '0.02em';
        topLeftCorner.style.minWidth = '200px';
        topLeftCorner.style.maxWidth = '350px';
        topLeftCorner.style.opacity = '0';
        topLeftCorner.style.transform = 'translateY(-8px) scale(0.95)';
        topLeftCorner.style.transition = 'all 0.2s cubic-bezier(0.16, 1, 0.3, 1)';
        ...
        function showEventInfo(eventType, element, haveEvent = false) {
            ...
            requestAnimationFrame(() => {
                ...
                topLeftCorner.style.transform = 'translateY(0px) scale(1)';
            });

            // Fonction moderne pour créer et afficher un tooltip
            function createModernTooltip(e, content) {
                // Nettoyer les tooltips existants
                clearAllTooltips();

                // Empêche le topLeftCorner de disparaître
